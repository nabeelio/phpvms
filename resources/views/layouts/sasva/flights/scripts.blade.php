        ...
        <script>
            $(document).ready(function() {
                ...
                $("button.save_flight").click(function(e) {
                    ...
                    $('#aircraft_select').attr('flight-saved-class', class_name)
                    $('#aircraft_select').attr('flight-id', flight_id)
                ...
                $('#with_aircraft').click(() => {
                    ...
                    const flight_id = $('#aircraft_select').attr('flight-id');
                    const class_name = $('#aircraft_select').attr('flight-saved-class')
                    phpvms.bids.addBid(flight_id, ac_id).then(() => {
                        console.log('successfully saved flight');
                        $('button.save_flight[flight-id="' + flight_id + '"]').addClass(class_name);
