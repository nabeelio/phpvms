<ul class="list-group">
  @foreach($files as $file)
    <li class="list-group-item">
      <a href="{{route('frontend.downloads.download', [$file->id])}}" target="_blank" @if(is_null($file->disk) && !str_contains($file->url, config('app.url'))) data-external-redirect="{{ $file->url }}" @endif>
        {{ $file->name }}
      </a>
