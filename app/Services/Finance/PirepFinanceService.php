    ...
    public function payFuelCosts(Pirep $pirep): void
    {
        ...
        if (setting('pireps.advanced_fuel', false)) {
            ...
            if ($prev_flight) {
                ...
                $fuel_amount = $pirep->block_fuel->value() - ($prev_flight->block_fuel->value() - $prev_flight->fuel_used->value());
                ...
                $fuel_amount = $pirep->block_fuel->value();
            }
        } else {
            // Setting is false, switch back to basic calculation
            $fuel_amount = $pirep->fuel_used->value();
        }
